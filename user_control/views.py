...
from chat3.custom_methods import IsAuthenticatedCustom
...
from .serializers import (LoginSerializer, RegisterSerializer, RefreshSerializer,  FavoriteSerializer,UserProfileSerializer, UserProfile)
